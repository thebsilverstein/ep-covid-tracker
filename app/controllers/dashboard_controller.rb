...
class DashboardController < ApplicationController
  def index
    ...
    @last_updated_on = Time.zone.parse("2020-06-04 12:41:00")
    ...
    patients_hospitalized_data = [19, 26, 27, 27, 27, 40, 48, 52, 48, 57, 58, 61, 65, 48, 38, 25, 29, 38, 37, 35, 33, 38, 36, 38, 35, 35, 52, 53, 58, 61, 59, 65, 71, 68, 62, 83, 82, 85, 80, 80, 73, 76, 74, 78, 74, 77, 107, 109, 109, 119, 116, 109, 112, 106, 110, 118, 111, 106, 103, 99, 96, 91, 106]
    patients_in_icu_data = [8, 8, 10, 10, 10, 12, 19, 21, 22, 23, 23, 26, 27, 10, 11, 10, 8, 13, 13, 18, 21, 26, 16, 18, 19, 19, 27, 31, 30, 39, 21, 38, 40, 39, 40, 47, 40, 39, 34, 40, 35, 38, 39, 41, 32, 35, 46, 52, 56, 65, 66, 61, 66, 67, 65, 67, 67, 59, 54, 56, 59, 54, 63]
    ...
    total_cases_by_age_range_data = [138, 161, 558, 550, 481, 503, 361, 177, 103, 36, 1]
    total_cases_by_age_range_max = 600

    total_deaths_by_age_range_data = [0, 0, 0, 0, 6, 15, 21, 23, 16, 8, 0]

    total_cases_by_gender_male = 1512
    ...
    @links = [ ["epstrong.org - May 21 – June 4, 2020", "http://epstrong.org/results.php"],
