...
class DashboardController < ApplicationController
  def index
    ...
    @last_updated_on = Time.zone.parse("2020-05-27 1:37:00 PM")
    ...
    total_cases_by_age_range_data = [119, 121, 433, 405, 387, 406, 306, 158, 90, 35, 1]
    total_cases_by_age_range_max = 450

    total_deaths_by_age_range_data = [0, 0, 0, 0, 5, 9, 18, 20, 11, 5, 0]

    total_cases_by_gender_male = 1169
    total_cases_by_gender_female = 1292
