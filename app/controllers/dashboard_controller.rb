class DashboardController < ApplicationController
  def index
    ...
    total_cases_by_gender_male = 52
    total_cases_by_gender_female = 63
    ...
    @total_cases_by_zip_code = [ [79821, "https://goo.gl/maps/fyDXByr3a6WyCLfh9", 1 ],
                                 ...
                                 [79934, "https://goo.gl/maps/ozgMKwoosWHWtDGPA", 4 ],
                                 [79935, "https://goo.gl/maps/jiS5uroU4meDaET68", 4 ],
                                 [79936, "https://goo.gl/maps/8bzvY2hcPK8qUcWu9", 19 ],
    ...
    zip_data = [[79821, [1, 1, 1, 1, 1,     1]],
                ...
                [79925, [2, 3, 4, 5, 5,     5]],
                [79927, [3, 3, 5, 7, 8,     8]],
                [79928, [8, 11, 11, 11, 13, 13]],
                [79932, [1, 2, 2, 6, 6,     7]],
                [79934, [2, 3, 3, 3, 3,     4]],
                [79935, [2, 3, 3, 4, 4,     4]],
                [79936, [5, 7, 9, 13, 16,   19]],
                [79938, [5, 8, 10, 12, 12,  15]],
                ]

    max_value = @total_cases_by_zip_code.map { |entry| entry[2] }.max

    @links = [ ["City of El Paso Facebook - April 5, 2020", "https://www.facebook.com/notes/city-of-el-paso-texas-municipal-government/covid-19-update-el-paso-identifies-additional-covid-19-cases/2927135207325903/"],
